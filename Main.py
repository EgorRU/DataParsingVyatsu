...
from Parsing.Equals import Equals, iEquals
...
def Main():
    ...
    #print()
    #iEquals(Scopus("Source/Scopus/Scopus1.xlsx"), IPublishing("Source/IPublishing/IPublishing.xlsx"))
    #iEquals(Wos("Source/Wos/Wos.xlsx"), IPublishing("Source/IPublishing/IPublishing.xlsx"))
